...
### 📁 mobile-ionic/
Мобильное приложение для Android и iOS на базе Ionic Framework
- **Технологии**: Ionic Framework, Capacitor, JavaScript, HTML5/CSS3
...
- **Требования**: Node.js 16+, Ionic CLI, Capacitor CLI
- **Среда разработки**: VS Code или любой современный редактор
- **Особенности**: PWA поддержка, cross-platform код, веб-совместимость
...
7. **Выбор технологий по платформам**:
   ...
   - Mobile: Ionic Framework + JavaScript (кросс-платформенность и веб-совместимость)
...
23. **Специфичные требования платформ**: Обязательное указание специальных требований для каждой платформы (например, JDK от Adoptium для мобильной разработки на Ionic Framework)
...
- **[TODO-MVP.md](mobile-ionic/TODO-MVP.md)** - MVP версия (35-50 дней, 7-10 недель)
  - **10 этапов разработки**: От настройки Ionic до Android/iOS build
  - **Мобильные особенности**: Touch-оптимизированные списки, pull-to-refresh, PWA поддержка
  - **Ограничения MVP**: Cross-platform web-приложение, без push-уведомлений
  - **Базовый функционал**: Просмотр задач, фильтрация, PDF экспорт, локальное кэширование
  - **Целевые платформы**: Веб-браузеры, Android, iOS, PWA

- **[TODO-FULL.md](mobile-ionic/TODO-FULL.md)** - Полная версия (80-115 дней, 16-23 недели)
  - **14 этапов разработки**: Включая полную нативную интеграцию и enterprise функции
  - **Cross-platform**: Полная поддержка всех платформ с нативными функциями
  - **Продвинутые возможности**: Biometric auth, push-уведомления, офлайн синхронизация
  - **Enterprise функции**: Адаптивный дизайн для планшетов, множественный экспорт
...
| Mobile | 7-10 недель | 16-23 недели | 2.3x |
| Backend | 9-12 недель | 23-32 недели | 2.7x |
| **Итого** | **19-27 недель** | **54-76 недель** | **2.6x** |
